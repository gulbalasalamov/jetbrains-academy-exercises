 ...
 * Implement a method that returns the third stream that contains sorted numbers from both streams which are divisible by 3 and 5 without the first two numbers.
 * You need return a prepared IntStream from a template method, not a list of integers. Pay attention to the method template. Do not change the signature of this method.
 * https://hyperskill.org/learn/step/2424
 */
